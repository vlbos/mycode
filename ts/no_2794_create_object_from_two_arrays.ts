...
// Input: arr1 = ["1", 1, false], arr2 = [4, 5, 6]
// Output: {"1": 4, "false": 6}
// Explanation: First, all the elements in arr1 are converted into strings. 
// We can see there are two occurrences of "1". The value associated with the first occurrence of "1" is used: 4.
