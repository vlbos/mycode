...
//   }
// }
// Explanation: The keys "a", "v", and "z" all had changes applied. "a" was changed from 1 to 2. 
// "v" was changed from 3 to 4. "z" had a change applied to a child object. "z.a" was changed from null to 2.
...
//   }
// }
// Explanation: In obj1 and obj2, the keys "v" and "z" have different assigned values. 
// "a" is ignored because the value is unchanged. In the key "z", there is a nested array. 
// Arrays are treated like objects where the indices are keys. 
// There were two alterations to the the array: z[2] and z[3][0]. 
...
//   "a": [{"b": 1}, [5]]
// }
// Explanation: The key "a" exists in both objects. 
// Since the two associated values have different types, they are placed in the difference array.
...
// Output: 
// {}
// Explanation: Apart from a different ordering of keys, 
// the two objects are identical so an empty object is returned.
