...
// Explanation: The keys from obj become the values in invertedObj, 
...
// Explanation: There are two keys in obj with the same value, 
// the invertedObj mapped the value to an array containing all corresponding keys.
