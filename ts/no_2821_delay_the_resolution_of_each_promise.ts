...
// It determines the amount of time to wait before resolving each promise in the new array.


// Each function in the new array should return a promise that resolves after a delay of ms milliseconds, 
// preserving the order of the original functions array. 
...
// ms = 50
// Output: [80]
// Explanation: The promise from the array would have resolved after 30 ms, 
...
// ms = 70
// Output: [120,150]
// Explanation: The promises from the array would have resolved after 50 ms and 80 ms, 
// but they were delayed by 70 ms, thus 50 ms + 70 ms = 120 ms and 80 ms + 70 ms = 150 ms.
