...
// Write your version of method forEach that enhances all arrays such that you can call the array.
// forEach(callback, context) method on any array and it will execute callback on each element of the array.
...
// It is the value of the element in the current iteration.
