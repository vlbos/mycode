...
// 	An asyncronous function queryMultiple which accepts an array of string keys input. 
...
// The first time getValue is called, queryMultiple should immediately be called with that single key. 
// If after t milliseconds, getValue had been called again, 
...
// The following diagram illustrates how the throttling algorithm works. Each rectangle represents 100ms. 
// The throttle time is 400ms.
...
// ]
// Explanation:
// This example is the same as example 1 except there is a 100ms delay in queryMultiple. 
// The results are the same except the promises resolve 100ms later.
