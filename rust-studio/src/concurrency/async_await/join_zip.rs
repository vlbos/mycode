...
pub fn main() {
    ...
    let _result = async {
        ...
        futures::select! {
        _res1 = future1 => { /* handle result of future1 */ },
        _res2 = future2 => { /* handle result of future2 */ },
        }
    };
    ...
    let future1 = async { /* future 1 */ };
    let future2 = async { /* future 2 */ };
    let (_res1, _res2) = futures::executor::block_on(async { futures::join!(future1, future2) });
    ...
    let _ = async {
        let _result: Result<((), ()), Error> = try_join!(future1, future2);
    };
}
pub fn smol_zip() {
    smol::block_on(async {
