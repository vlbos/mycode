...
impl Solution {
    pub fn generate_palindromes(s: String) -> Vec<String> {
        ...
        fn decount(counter: &mut HashMap<char, usize>, ch: char, times: usize) {
        ...
        fn generate_palindromes_rec(
            ...
            if counter.len() == 0 {
                ...
                for k in counter.keys() {
                    ...
                    generate_palindromes_rec(res.clone(), new_counter, new_visited);
                }
            }
        }
        generate_palindromes_rec(res_rc.clone(), counter, String::from(""));
    ...
    pub fn generate_palindromes2(s: String) -> Vec<String> {
    ...
    pub fn generate_palindromes3(s: String) -> Vec<String> {
