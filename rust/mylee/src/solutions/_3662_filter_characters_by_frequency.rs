...
mod test {
    ...
    #[test]
    pub fn test_filter_characters_1() {
        assert_eq!(
            String::from("dbb"),
            Solution::filter_characters(String::from("aadbbcccca"), 3)
        );
    }
    #[test]
    pub fn test_filter_characters_2() {
        assert_eq!(
            String::from("xyz"),
            Solution::filter_characters(String::from("xyz"), 2)
        );
    }
}
