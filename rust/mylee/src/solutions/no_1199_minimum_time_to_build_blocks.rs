...
mod test {
    ...
    pub fn test_min_build_time_1() {
        assert_eq!(1, Solution::min_build_time(vec![1], 1));
    }
    #[test]
    pub fn test_min_build_time_2() {
        assert_eq!(7, Solution::min_build_time(vec![1, 2], 5));
    }
    #[test]
    pub fn test_min_build_time_3() {
        assert_eq!(4, Solution::min_build_time(vec![1, 2, 3], 1));
    }
}
