...
impl Solution {
    pub fn num_islands2i(m: i32, n: i32, positions: Vec<Vec<i32>>) -> Vec<i32> {
        ...
        for pos in positions {
            ...
            for movement in &MOVEMENTS {
                ...
                if next_x >= 0 && next_y >= 0 && next_x < (m as isize) && next_y < (n as isize) {
                    let next_id = pos2id(next_x as usize, next_y as usize, m, n);
    ...
    pub fn num_islands2error(m: i32, n: i32, positions: Vec<Vec<i32>>) -> Vec<i32> {
