...
mod test {
    ...
    #[test]
    fn test_expand_1() {
        assert_eq!(["acdf","acef","bcdf","bcef"].into_iter().map(String::from).collect::<Vec<String>>(), Solution::expand(String::from("{a,b}c{d,e}f")));
    }
    #[test]
    fn test_expand_2() {
        assert_eq!(vec!["abcd".to_string()], Solution::expand(String::from("abcd")));
    }
}
