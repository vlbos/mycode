...
// int max_subarray_length(vector<int>& nums) {
...
mod test {
    use super::*;
    #[test]
    pub fn test_max_subarray_length_1() {
        assert_eq!(
            8,
            Solution::max_subarray_length(vec![7, 6, 5, 4, 3, 2, 1, 6, 10, 11])
        );
    }
    #[test]
    pub fn test_max_subarray_length_2() {
        assert_eq!(
            6,
            Solution::max_subarray_length(vec![57, 55, 50, 60, 61, 58, 63, 59, 64, 60, 63])
        );
    }
    #[test]
    pub fn test_max_subarray_length_3() {
        assert_eq!(0, Solution::max_subarray_length(vec![1, 2, 3, 4]));
    }
}
