...
# Olympic table:
# +-------------+-------------+---------------+---------------+
# | country     | gold\_medals | silver\_medals | bronze\_medals |
# +-------------+-------------+---------------+---------------+
# | China       | 10          | 10            | 20            |
# | South Sudan | 0           | 0             | 1             |
# | USA         | 10          | 10            | 20            |
...
def sort_table(olympic: pd.DataFrame) -> pd.DataFrame:
    return olympic.sort_values(by = ["gold_medals","silver_medals",'bronze_medals',"country"],ascending = [False,False,False,True])