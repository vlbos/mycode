...
# | team\_id       | int     |
# +---------------+---------+
# employee\_id is the primary key (column with unique values) for this table.
...
# Employee with Id 4 is part of a team with team\_id = 7.
...
def team_size(employee: pd.DataFrame) -> pd.DataFrame:
    return employee.assign(team_size = employee.groupby("team_id").transform("count")).iloc[:,[0,2]]