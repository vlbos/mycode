...
现在，定义 $K$ 个非负整数 $A\_1,A\_2,…,A\_K$ 的 $XOR$ 和为：

$$A\_1\\ XOR\\ A\_2\\ XOR\\ …\\ XOR\\ A\_K$$
...
接下来 $M$ 行描述 $M$ 条边，每行三个整数 $S\_i，T\_i ，D\_i$，表示 $S\_i$ 与 $T\_i$ 之间存在一条权值为 $D\_i$ 的无向边。
...
$ N \\le 50000 , M \\le 100000, D\_i \\le 10^{18}$
