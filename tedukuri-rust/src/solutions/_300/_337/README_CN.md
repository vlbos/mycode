...
牌的表示方法为XY，其中X为面值，为 2、3、4、5、6、7、8、9、T、J、Q、K、A2、3、4、5、6、7、8、9、T、J、Q、K、A 中的一个。
...
对于每组数据输出一行，形如 `Case #X: Y`，XX 为数据组数，从1开始，YY 为可能的方案数。

由于答案可能很大，请输出对264取模之后的值。
