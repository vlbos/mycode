...
// ![](https://assets.leetcode.com/uploads/2023/05/14/example1.png)
...
// ![](https://assets.leetcode.com/uploads/2023/05/14/example2.png)
...
// ![](https://assets.leetcode.com/uploads/2023/05/14/example3.png)
...
func getKthCharacter(root *RopeTreeNode, k int) byte {
    var dfs func(root *RopeTreeNode, k *int)byte
    dfs=func(root *RopeTreeNode, k *int)byte{
        if root==nil{
            return 0
        }
        if root.len>0 {
