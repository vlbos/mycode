...
// Task queue that will contain all the tasks that need to be run. 
// This will be a std::sync::mpsc::sync_channel.
// Waker that will be used to wake up the runtime when a task is ready to be polled.
